 ...
 */
extern PyObject *modulecode_nuitka_fib(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"nuitka_fib", modulecode_nuitka_fib, 0, 0, NUITKA_TRANSLATED_FLAG
